                          ...
                          children: [
                            ...
                            if (stateUI.showQuantity)
                             Column(
                              ...
                              children: [
                                Text(
                                  Localizations.localeOf(context).languageCode == 'fr' ? 'Quantité:' : 'Quantity:',
                                  style: Theme.of(context).textTheme.bodyMedium,
                                ),
                                const SizedBox(height: 4), // Add spacing between the label and the QuantitySelection widget
                                QuantitySelection(
                                  enabled: stateUI.inStock && stateUI.onChangeQuantity != null,
                                  width: 60,
                                  height: 32,
