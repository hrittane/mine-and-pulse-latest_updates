...
class MenuBarState extends State<SideBarMenu> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              if (logo != null) ...[
                Container(
                  width: double.infinity, // Set the container to take 100% width of the parent
  ...
  Widget drawerItem(
    ...
    switch (value) {
      ...
      case 'web-dKFYeDoFumServices': // Check for Services
        {
          return ExpansionTile(
            leading: Icon(
              Icons.format_list_bulleted, // Example icon for Services
              size: 20,
              color: iconColor,
            ),
            title: Text(
              'Services', // Title for Services
              style: textStyle,
            ),
            children: ['web-dKFYeDoFumm1','web-dKFYeDoFumm2'].map((entry) {
              var item = subDrawerItem[entry];
              return 
                GeneralWebWidget(
                  item: item,
                  useTile: true,
